...
workflow {
    if (!params.step) error "Please provide --step <name>. Valid steps: downsample_xenium_region, create_sdata, create_follicle_sdata, cluster_sdata, concat_sdata, downsample_sdata, plot_follicle"
    ...
    else error "Unknown --step '${params.step}'. Valid steps: downsample_xenium_region, create_sdata, create_follicle_sdata, cluster_sdata, concat_sdata, downsample_sdata, plot_follicle"
}
